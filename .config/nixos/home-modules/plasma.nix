{ options, ... }: {
  ...
  in {
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."18729546-c057-4fd4-a4fd-9a9aa7b4a44a".value =
        "Default";
      ...
      "kglobalshortcutsrc"."mediacontrol"."_k_friendly_name".value =
        "Media Controller";
      "kglobalshortcutsrc"."org.kde.dolphin.desktop"."_k_friendly_name".value =
        "Dolphin";
      "kglobalshortcutsrc"."org.kde.konsole.desktop"."_k_friendly_name".value =
        "Konsole";
      "kglobalshortcutsrc"."org.kde.krunner.desktop"."_k_friendly_name".value =
        "KRunner";
      "kglobalshortcutsrc"."org.kde.plasma.emojier.desktop"."_k_friendly_name".value =
        "Emoji Selector";
      "kglobalshortcutsrc"."org.kde.spectacle.desktop"."_k_friendly_name".value =
        "Spectacle";
      "kglobalshortcutsrc"."org_kde_powerdevil"."_k_friendly_name".value =
        "Power Management";
      "kglobalshortcutsrc"."plasmashell"."_k_friendly_name".value =
        "Activity switching";
      "kglobalshortcutsrc"."systemsettings.desktop"."_k_friendly_name".value =
        "System Settings";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid".value =
        "{6e7556b0-59f2-4637-93d8-eab1bf2ab928}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid".value =
        "{ebad9126-7d7a-4698-9bad-5c330ec992a5}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid".value =
        "{8e4549d7-7c38-45f1-8fcf-723ac7c025d7}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid".value =
        "{35cace53-6662-451e-a219-84e4ea686bb0}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid".value =
        "{fba8d93a-3510-40e8-866b-0c299fc281d6}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid".value =
        "{04312a12-280c-4670-8dfa-c507a26ef1b0}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid".value =
        "{2f085245-1b22-41e1-a8ec-efeb536790f3}";
