    ...
    config = function()
      require('bamboo').setup {
        ...
        highlights = {
          ...
          -- Without https://github.com/neovim/neovim/issues/35806, we need to
          -- define many custom highlight groups here
          ...
          TabMiniIconsAzure = { fg = '$bg_blue', bg = '$bg1' },
          TabMiniIconsBlue = { fg = '$blue', bg = '$bg1' },
          TabMiniIconsCyan = { fg = '$cyan', bg = '$bg1' },
          TabMiniIconsGreen = { fg = '$green', bg = '$bg1' },
          TabMiniIconsGrey = { fg = '$light_grey', bg = '$bg1' },
          TabMiniIconsOrange = { fg = '$orange', bg = '$bg1' },
          TabMiniIconsPurple = { fg = '$purple', bg = '$bg1' },
          TabMiniIconsRed = { fg = '$red', bg = '$bg1' },
          TabMiniIconsYellow = { fg = '$yellow', bg = '$bg1' },
          TabMiniIconsAzureSel = { fg = '$bg_blue', bg = '$bg0' },
          TabMiniIconsBlueSel = { fg = '$blue', bg = '$bg0' },
          TabMiniIconsCyanSel = { fg = '$cyan', bg = '$bg0' },
          TabMiniIconsGreenSel = { fg = '$green', bg = '$bg0' },
          TabMiniIconsGreySel = { fg = '$light_grey', bg = '$bg0' },
          TabMiniIconsOrangeSel = { fg = '$orange', bg = '$bg0' },
          TabMiniIconsPurpleSel = { fg = '$purple', bg = '$bg0' },
          TabMiniIconsRedSel = { fg = '$red', bg = '$bg0' },
          TabMiniIconsYellowSel = { fg = '$yellow', bg = '$bg0' },
        },
      }
