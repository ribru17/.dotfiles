...
ble-face -s argument_option fg=#d06060,italic
ble-face -s auto_complete fg=#a1a7a0,italic
ble-face -s cmdinfo_cd_cdpath fg=#6e9fe5,bg=black,italic
ble-face -s command_alias fg=blue
ble-face -s command_builtin fg=#df7946
ble-face -s command_directory fg=#6e9fe5
...
ble-face -s filename_directory fg=#6e9fe5
...
ble-face -s filename_setuid fg=black,bg=#df7946,underline
# TODO: Find a way to get the latest blesh version in nix and then add this back
# ble-face -s menu_filter_input fg=black,bg=#855505
...
ble-face -s varname_array fg=#df7946
ble-face -s varname_empty fg=#df7946
ble-face -s varname_export fg=#df7946
ble-face -s varname_expr fg=#df7946
ble-face -s varname_hash fg=#df7946
ble-face -s varname_number fg=none
ble-face -s varname_readonly fg=#df7946
ble-face -s varname_transform fg=#df7946
