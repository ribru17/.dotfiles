...
return {
  ...
  s({ trig = '~~', wordTrig = false }, fmt([[\approx]], {}),
    { condition = in_mathzone }),
  s({ trig = '=>', wordTrig = false }, fmt([[\Rightarrow]], {}),
    { condition = in_mathzone }),
  s({ trig = '==>', wordTrig = false, priority = 1001 }, fmt([[\implies]], {}),
    { condition = in_mathzone }),
  ...
  s({ trig = 'EE', wordTrig = false }, fmt([[\exists]], {}),
    { condition = in_mathzone }),
  s({ trig = 'exists', wordTrig = false }, fmt([[\exists]], {}),
    { condition = in_mathzone }),
  s({ trig = 'AA', wordTrig = false }, fmt([[\forall]], {}),
    { condition = in_mathzone }),
  s({ trig = 'forall', wordTrig = false }, fmt([[\forall]], {}),
    { condition = in_mathzone }),
  ...
  s({ trig = 'iff', wordTrig = false }, fmt([[\iff]], {}),
    { condition = in_mathzone }),
  s({ trig = '\\le>', wordTrig = false }, fmt([[\Leftrightarrow]], {}),
    { condition = in_mathzone }),
  s({ trig = '\\le=>', wordTrig = false, priority = 1001 }, fmt([[\iff]], {}),
    { condition = in_mathzone }),
  ...
  s({ trig = 'HH', wordTrig = false }, fmt([[\mathbb{{H}}]], {}),
    { condition = in_mathzone }),
  s({ trig = 'WW', wordTrig = false }, fmt([[\mathbb{{W}}]], {}),
    { condition = in_mathzone }),
  ...
  s({ trig = 'in' }, fmt([[\in]], {}),
    { condition = in_mathzone }),
  s({ trig = 'alpha' }, fmt([[\alpha]], {}),
    { condition = in_mathzone }),
  s({ trig = 'Alpha' }, fmt([[\Alpha]], {}),
    { condition = in_mathzone }),
  s({ trig = 'beta' }, fmt([[\beta]], {}),
    { condition = in_mathzone }),
  s({ trig = 'Beta' }, fmt([[\Beta]], {}),
    { condition = in_mathzone }),
  s({ trig = 'gamma' }, fmt([[\gamma]], {}),
    { condition = in_mathzone }),
  s({ trig = 'Gamma' }, fmt([[\Gamma]], {}),
    { condition = in_mathzone }),
  s({ trig = 'delta' }, fmt([[\delta]], {}),
    { condition = in_mathzone }),
  s({ trig = 'Delta' }, fmt([[\Delta]], {}),
    { condition = in_mathzone }),
  s({ trig = 'epsilon' }, fmt([[\epsilon]], {}),
    { condition = in_mathzone }),
  s({ trig = 'Epsilon' }, fmt([[\Epsilon]], {}),
    { condition = in_mathzone }),
  s({ trig = 'zeta' }, fmt([[\zeta]], {}),
    { condition = in_mathzone }),
  s({ trig = 'Zeta' }, fmt([[\Zeta]], {}),
    { condition = in_mathzone }),
  s({ trig = 'eta' }, fmt([[\eta]], {}),
  ...
  s({ trig = 'Eta' }, fmt([[\Eta]], {}),
    { condition = in_mathzone }),
  s({ trig = 'theta' }, fmt([[\theta]], {}),
    { condition = in_mathzone }),
  s({ trig = 'Theta' }, fmt([[\Theta]], {}),
    { condition = in_mathzone }),
  s({ trig = 'iota' }, fmt([[\iota]], {}),
    { condition = in_mathzone }),
  s({ trig = 'Iota' }, fmt([[\Iota]], {}),
    { condition = in_mathzone }),
  s({ trig = 'kappa' }, fmt([[\kappa]], {}),
    { condition = in_mathzone }),
  s({ trig = 'Kappa' }, fmt([[\Kappa]], {}),
    { condition = in_mathzone }),
  s({ trig = 'lambda' }, fmt([[\lambda]], {}),
    { condition = in_mathzone }),
  s({ trig = 'Lambda' }, fmt([[\Lambda]], {}),
    { condition = in_mathzone }),
  s({ trig = 'mu' }, fmt([[\mu]], {}),
